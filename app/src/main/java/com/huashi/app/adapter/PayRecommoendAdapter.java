 ...
 */
public class PayRecommoendAdapter extends BaseAdapter {
    Context context;
    List<RecommendCommtity.CommoditysBean> list;
   public PayRecommoendAdapter(Context context, List<RecommendCommtity.CommoditysBean> list){
       this.context=context;
       this.list=list;
       Log.e("商品大小",list.size()+"");
   }
    @Override
    public int getCount() {
        return list.size();
